...
func TestZScenario1_DatabaseInitializationOnFirstInsert(t *testing.T) {
...
// without git context
func TestZScenario2_InsertSimpleCommandWithoutGitContext(t *testing.T) {
...
func TestZScenario3_InsertCommandWithGitContext(t *testing.T) {
	// Given: the shy database exists
	tempDir := t.TempDir()
	dbPath := filepath.Join(tempDir, "history.db")
	database, err := NewZ(dbPath)
...
func TestZScenario4_InsertCommandWithNonZeroExitStatus(t *testing.T) {
	// Given: the shy database exists
	tempDir := t.TempDir()
	dbPath := filepath.Join(tempDir, "history.db")
	database, err := NewZ(dbPath)
...
func TestZScenario5_InsertMultipleCommandsSequentially(t *testing.T) {
...
func TestZScenario6_InsertCommandWithSpecialCharacters(t *testing.T) {
	// Given: the shy database exists
	tempDir := t.TempDir()
	dbPath := filepath.Join(tempDir, "history.db")
	database, err := NewZ(dbPath)
...
// captured completely
func TestZScenario7_InsertVeryLongCommand(t *testing.T) {
	// Given: the shy database exists
	tempDir := t.TempDir()
	dbPath := filepath.Join(tempDir, "history.db")
	database, err := NewZ(dbPath)
...
func TestZGetCommandsByDateRange(t *testing.T) {
...
func TestZGetCommandsByDateRange_EmptyResult(t *testing.T) {
...
func TestZGetCommandsByDateRange_BoundaryConditions(t *testing.T) {
...
func TestZGetContextSummary(t *testing.T) {
...
// TestZGetCommandsByRange tests that GetCommandsByRange returns unique commands
func TestZGetCommandsByRange(t *testing.T) {
...
func TestZGetCommandsByRangeWithPattern(t *testing.T) {
...
func TestZGetCommandsByRangeInternal(t *testing.T) {
...
func TestZGetCommandsByRangeWithPatternInternal(t *testing.T) {
...
func TestZListCommandsInRange(t *testing.T) {
...
func TestZGetRecentCommandsWithoutConsecutiveDuplicates_UnionWithDirectory(t *testing.T) {
